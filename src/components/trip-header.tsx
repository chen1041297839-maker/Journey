...
export function TripHeader() {
  ...
  return (
    <header className="relative overflow-hidden border-b border-border/80">
      ...
      <div className="mx-auto flex w-full min-w-0 max-w-6xl flex-col gap-5 px-4 py-6 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:py-8">
        <div className="max-w-2xl">
          ...
          <Link href="/" className="mt-2 inline-block">
            <h1 className="font-heading text-3xl leading-tight tracking-normal sm:text-4xl">
              Xenia 的行程站
            </h1>
          </Link>
